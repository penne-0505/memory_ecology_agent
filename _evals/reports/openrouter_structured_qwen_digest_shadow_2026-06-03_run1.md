...
| --- | --- | --- | --- | --- | --- | --- |
| `qwen/qwen3.6-plus` | `safe_batch` | `completed` | `0` | `16` | `{'provider_error': 16}` | `1.4` |

## Observation Partials

| Model | Observation | Status | Schema Valid | Fallback | Cause | Elapsed |
| --- | --- | --- | --- | --- | --- | --- |
| `qwen/qwen3.6-plus` | `4` | `failed` | `False` | `True` | `provider_error` | `0.4` |
| `qwen/qwen3.6-plus` | `3` | `failed` | `False` | `True` | `provider_error` | `0.4` |
| `qwen/qwen3.6-plus` | `1` | `failed` | `False` | `True` | `provider_error` | `0.5` |
| `qwen/qwen3.6-plus` | `2` | `failed` | `False` | `True` | `provider_error` | `0.5` |
| `qwen/qwen3.6-plus` | `5` | `failed` | `False` | `True` | `provider_error` | `0.1` |
| `qwen/qwen3.6-plus` | `6` | `failed` | `False` | `True` | `provider_error` | `0.2` |
| `qwen/qwen3.6-plus` | `7` | `failed` | `False` | `True` | `provider_error` | `0.2` |
| `qwen/qwen3.6-plus` | `8` | `failed` | `False` | `True` | `provider_error` | `0.2` |
| `qwen/qwen3.6-plus` | `9` | `failed` | `False` | `True` | `provider_error` | `0.2` |
| `qwen/qwen3.6-plus` | `10` | `failed` | `False` | `True` | `provider_error` | `0.2` |
| `qwen/qwen3.6-plus` | `11` | `failed` | `False` | `True` | `provider_error` | `0.2` |
| `qwen/qwen3.6-plus` | `12` | `failed` | `False` | `True` | `provider_error` | `0.3` |
| `qwen/qwen3.6-plus` | `13` | `failed` | `False` | `True` | `provider_error` | `0.3` |
| `qwen/qwen3.6-plus` | `14` | `failed` | `False` | `True` | `provider_error` | `0.3` |
| `qwen/qwen3.6-plus` | `15` | `failed` | `False` | `True` | `provider_error` | `0.4` |
