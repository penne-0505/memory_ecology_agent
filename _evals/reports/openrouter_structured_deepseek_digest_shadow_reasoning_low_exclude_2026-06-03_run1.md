...
- failure_cause_counts: `{'malformed_json': 3}`
...
| --- | --- | --- | --- | --- | --- | --- |
| `deepseek/deepseek-v4-pro` | `safe_batch` | `completed` | `13` | `3` | `{'malformed_json': 3}` | `112.0` |
...
| --- | --- | --- | --- | --- | --- | --- |
| `deepseek/deepseek-v4-pro` | `4` | `completed` | `True` | `False` | `` | `10.9` |
| `deepseek/deepseek-v4-pro` | `3` | `completed` | `True` | `False` | `` | `18.8` |
| `deepseek/deepseek-v4-pro` | `1` | `completed` | `True` | `False` | `` | `22.0` |
| `deepseek/deepseek-v4-pro` | `5` | `completed` | `True` | `False` | `` | `11.8` |
| `deepseek/deepseek-v4-pro` | `2` | `completed` | `True` | `False` | `` | `22.7` |
| `deepseek/deepseek-v4-pro` | `7` | `completed` | `True` | `False` | `` | `15.4` |
| `deepseek/deepseek-v4-pro` | `9` | `completed` | `True` | `False` | `` | `18.1` |
| `deepseek/deepseek-v4-pro` | `6` | `completed` | `True` | `False` | `` | `24.5` |
| `deepseek/deepseek-v4-pro` | `8` | `failed` | `False` | `True` | `malformed_json` | `27.1` |
| `deepseek/deepseek-v4-pro` | `11` | `completed` | `True` | `False` | `` | `12.9` |
| `deepseek/deepseek-v4-pro` | `12` | `completed` | `True` | `False` | `` | `12.8` |
| `deepseek/deepseek-v4-pro` | `13` | `completed` | `True` | `False` | `` | `8.0` |
| `deepseek/deepseek-v4-pro` | `10` | `completed` | `True` | `False` | `` | `22.6` |
| `deepseek/deepseek-v4-pro` | `14` | `failed` | `False` | `True` | `malformed_json` | `15.4` |
| `deepseek/deepseek-v4-pro` | `16` | `completed` | `True` | `False` | `` | `38.7` |
| `deepseek/deepseek-v4-pro` | `15` | `failed` | `False` | `True` | `malformed_json` | `55.8` |
