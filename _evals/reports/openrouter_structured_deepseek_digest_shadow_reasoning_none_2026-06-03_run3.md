...
| --- | --- | --- | --- | --- | --- | --- |
| `deepseek/deepseek-v4-pro` | `safe_batch` | `completed` | `16` | `0` | `{}` | `30.8` |
...
| --- | --- | --- | --- | --- | --- | --- |
| `deepseek/deepseek-v4-pro` | `4` | `completed` | `True` | `False` | `` | `3.2` |
| `deepseek/deepseek-v4-pro` | `1` | `completed` | `True` | `False` | `` | `4.1` |
| `deepseek/deepseek-v4-pro` | `2` | `completed` | `True` | `False` | `` | `4.2` |
| `deepseek/deepseek-v4-pro` | `3` | `completed` | `True` | `False` | `` | `4.4` |
| `deepseek/deepseek-v4-pro` | `6` | `completed` | `True` | `False` | `` | `3.3` |
| `deepseek/deepseek-v4-pro` | `7` | `completed` | `True` | `False` | `` | `3.2` |
| `deepseek/deepseek-v4-pro` | `5` | `completed` | `True` | `False` | `` | `4.3` |
| `deepseek/deepseek-v4-pro` | `8` | `completed` | `True` | `False` | `` | `3.4` |
| `deepseek/deepseek-v4-pro` | `9` | `completed` | `True` | `False` | `` | `3.9` |
| `deepseek/deepseek-v4-pro` | `12` | `completed` | `True` | `False` | `` | `3.6` |
| `deepseek/deepseek-v4-pro` | `10` | `completed` | `True` | `False` | `` | `4.0` |
| `deepseek/deepseek-v4-pro` | `15` | `completed` | `True` | `False` | `` | `4.0` |
| `deepseek/deepseek-v4-pro` | `14` | `completed` | `True` | `False` | `` | `5.5` |
| `deepseek/deepseek-v4-pro` | `16` | `completed` | `True` | `False` | `` | `3.2` |
| `deepseek/deepseek-v4-pro` | `11` | `completed` | `True` | `False` | `` | `14.5` |
| `deepseek/deepseek-v4-pro` | `13` | `completed` | `True` | `False` | `` | `19.4` |
