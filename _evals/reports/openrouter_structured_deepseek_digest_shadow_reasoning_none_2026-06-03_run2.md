...
| --- | --- | --- | --- | --- | --- | --- |
| `deepseek/deepseek-v4-pro` | `safe_batch` | `completed` | `16` | `0` | `{}` | `16.2` |
...
| --- | --- | --- | --- | --- | --- | --- |
| `deepseek/deepseek-v4-pro` | `2` | `completed` | `True` | `False` | `` | `2.7` |
| `deepseek/deepseek-v4-pro` | `1` | `completed` | `True` | `False` | `` | `2.9` |
| `deepseek/deepseek-v4-pro` | `3` | `completed` | `True` | `False` | `` | `3.3` |
| `deepseek/deepseek-v4-pro` | `4` | `completed` | `True` | `False` | `` | `3.4` |
| `deepseek/deepseek-v4-pro` | `6` | `completed` | `True` | `False` | `` | `3.6` |
| `deepseek/deepseek-v4-pro` | `7` | `completed` | `True` | `False` | `` | `3.4` |
| `deepseek/deepseek-v4-pro` | `8` | `completed` | `True` | `False` | `` | `3.4` |
| `deepseek/deepseek-v4-pro` | `5` | `completed` | `True` | `False` | `` | `4.0` |
| `deepseek/deepseek-v4-pro` | `11` | `completed` | `True` | `False` | `` | `3.7` |
| `deepseek/deepseek-v4-pro` | `9` | `completed` | `True` | `False` | `` | `4.4` |
| `deepseek/deepseek-v4-pro` | `10` | `completed` | `True` | `False` | `` | `4.3` |
| `deepseek/deepseek-v4-pro` | `12` | `completed` | `True` | `False` | `` | `4.4` |
| `deepseek/deepseek-v4-pro` | `14` | `completed` | `True` | `False` | `` | `3.2` |
| `deepseek/deepseek-v4-pro` | `16` | `completed` | `True` | `False` | `` | `3.9` |
| `deepseek/deepseek-v4-pro` | `15` | `completed` | `True` | `False` | `` | `4.3` |
| `deepseek/deepseek-v4-pro` | `13` | `completed` | `True` | `False` | `` | `5.6` |
