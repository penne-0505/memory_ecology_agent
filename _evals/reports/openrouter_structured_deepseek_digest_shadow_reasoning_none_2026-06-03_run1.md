...
| --- | --- | --- | --- | --- | --- | --- |
| `deepseek/deepseek-v4-pro` | `safe_batch` | `completed` | `16` | `0` | `{}` | `34.5` |
...
| --- | --- | --- | --- | --- | --- | --- |
| `deepseek/deepseek-v4-pro` | `2` | `completed` | `True` | `False` | `` | `3.9` |
| `deepseek/deepseek-v4-pro` | `1` | `completed` | `True` | `False` | `` | `3.9` |
| `deepseek/deepseek-v4-pro` | `4` | `completed` | `True` | `False` | `` | `7.4` |
| `deepseek/deepseek-v4-pro` | `7` | `completed` | `True` | `False` | `` | `2.8` |
| `deepseek/deepseek-v4-pro` | `6` | `completed` | `True` | `False` | `` | `6.6` |
| `deepseek/deepseek-v4-pro` | `8` | `completed` | `True` | `False` | `` | `2.8` |
| `deepseek/deepseek-v4-pro` | `3` | `completed` | `True` | `False` | `` | `15.6` |
| `deepseek/deepseek-v4-pro` | `11` | `completed` | `True` | `False` | `` | `8.4` |
| `deepseek/deepseek-v4-pro` | `5` | `completed` | `True` | `False` | `` | `20.9` |
| `deepseek/deepseek-v4-pro` | `9` | `completed` | `True` | `False` | `` | `14.5` |
| `deepseek/deepseek-v4-pro` | `10` | `completed` | `True` | `False` | `` | `12.2` |
| `deepseek/deepseek-v4-pro` | `14` | `completed` | `True` | `False` | `` | `2.5` |
| `deepseek/deepseek-v4-pro` | `12` | `completed` | `True` | `False` | `` | `3.6` |
| `deepseek/deepseek-v4-pro` | `15` | `completed` | `True` | `False` | `` | `3.7` |
| `deepseek/deepseek-v4-pro` | `16` | `completed` | `True` | `False` | `` | `3.6` |
| `deepseek/deepseek-v4-pro` | `13` | `completed` | `True` | `False` | `` | `9.7` |
