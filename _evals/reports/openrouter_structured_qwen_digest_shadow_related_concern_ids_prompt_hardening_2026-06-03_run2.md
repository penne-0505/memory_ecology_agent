...
| --- | --- | --- | --- | --- | --- | --- |
| `qwen/qwen3.6-plus` | `safe_batch` | `completed` | `16` | `0` | `{}` | `115.8` |
...
| --- | --- | --- | --- | --- | --- | --- |
| `qwen/qwen3.6-plus` | `2` | `completed` | `True` | `False` | `` | `19.5` |
| `qwen/qwen3.6-plus` | `4` | `completed` | `True` | `False` | `` | `23.1` |
| `qwen/qwen3.6-plus` | `3` | `completed` | `True` | `False` | `` | `31.0` |
| `qwen/qwen3.6-plus` | `1` | `completed` | `True` | `False` | `` | `33.5` |
| `qwen/qwen3.6-plus` | `5` | `completed` | `True` | `False` | `` | `27.7` |
| `qwen/qwen3.6-plus` | `7` | `completed` | `True` | `False` | `` | `23.5` |
| `qwen/qwen3.6-plus` | `8` | `completed` | `True` | `False` | `` | `21.6` |
| `qwen/qwen3.6-plus` | `6` | `completed` | `True` | `False` | `` | `32.5` |
| `qwen/qwen3.6-plus` | `9` | `completed` | `True` | `False` | `` | `20.2` |
| `qwen/qwen3.6-plus` | `12` | `completed` | `True` | `False` | `` | `22.8` |
| `qwen/qwen3.6-plus` | `11` | `completed` | `True` | `False` | `` | `24.2` |
| `qwen/qwen3.6-plus` | `10` | `completed` | `True` | `False` | `` | `30.6` |
| `qwen/qwen3.6-plus` | `13` | `completed` | `True` | `False` | `` | `28.6` |
| `qwen/qwen3.6-plus` | `15` | `completed` | `True` | `False` | `` | `22.3` |
| `qwen/qwen3.6-plus` | `14` | `completed` | `True` | `False` | `` | `24.3` |
| `qwen/qwen3.6-plus` | `16` | `completed` | `True` | `False` | `` | `30.8` |
