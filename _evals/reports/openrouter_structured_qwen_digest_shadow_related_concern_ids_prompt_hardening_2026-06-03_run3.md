...
| --- | --- | --- | --- | --- | --- | --- |
| `qwen/qwen3.6-plus` | `safe_batch` | `completed` | `16` | `0` | `{}` | `124.1` |
...
| --- | --- | --- | --- | --- | --- | --- |
| `qwen/qwen3.6-plus` | `3` | `completed` | `True` | `False` | `` | `27.5` |
| `qwen/qwen3.6-plus` | `4` | `completed` | `True` | `False` | `` | `31.2` |
| `qwen/qwen3.6-plus` | `2` | `completed` | `True` | `False` | `` | `37.0` |
| `qwen/qwen3.6-plus` | `1` | `completed` | `True` | `False` | `` | `37.2` |
| `qwen/qwen3.6-plus` | `5` | `completed` | `True` | `False` | `` | `16.1` |
| `qwen/qwen3.6-plus` | `6` | `completed` | `True` | `False` | `` | `23.5` |
| `qwen/qwen3.6-plus` | `9` | `completed` | `True` | `False` | `` | `15.1` |
| `qwen/qwen3.6-plus` | `8` | `completed` | `True` | `False` | `` | `22.0` |
| `qwen/qwen3.6-plus` | `7` | `completed` | `True` | `False` | `` | `30.0` |
| `qwen/qwen3.6-plus` | `12` | `completed` | `True` | `False` | `` | `21.4` |
| `qwen/qwen3.6-plus` | `13` | `completed` | `True` | `False` | `` | `16.7` |
| `qwen/qwen3.6-plus` | `10` | `completed` | `True` | `False` | `` | `30.3` |
| `qwen/qwen3.6-plus` | `11` | `completed` | `True` | `False` | `` | `29.7` |
| `qwen/qwen3.6-plus` | `15` | `completed` | `True` | `False` | `` | `23.5` |
| `qwen/qwen3.6-plus` | `14` | `completed` | `True` | `False` | `` | `30.1` |
| `qwen/qwen3.6-plus` | `16` | `completed` | `True` | `False` | `` | `39.0` |
