...
const FRONTMATTER_VALID = [
  "_evals/validator-fixtures/frontmatter/valid",
];
const FRONTMATTER_INVALID = [
  "_evals/validator-fixtures/frontmatter/invalid/wrong-marker-intent.md",
  "_evals/validator-fixtures/frontmatter/invalid/wrong-marker-qa.md",
  "_evals/validator-fixtures/frontmatter/invalid/unknown-marker.md",
